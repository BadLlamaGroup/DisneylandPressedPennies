...
public class MapsActivity extends Fragment implements Data, GoogleMap.OnInfoWindowClickListener, OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, GoogleMap.OnMyLocationButtonClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Map of Coins");
        ...
        if (extras != null) {
            ...
            Machine mac = gson.fromJson(jsonMachine, Machine.class);
            // Set machine if coming from machine detail page
            selectedMac = mac;
        }

        MapView mMapView = (MapView) myFragmentView.findViewById(R.id.mapView);
    ...
    private void startLocationUpdates() {
        ...
        if (locationApproved) {
            ...
            startLoc = (LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient));
        }
    }
